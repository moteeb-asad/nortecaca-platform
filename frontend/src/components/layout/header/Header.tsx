      ...
      <nav className="p-0">
        <div className="mx-auto w-full max-w-[1320px] px-4 py-[15px] sm:px-6 lg:px-8 xl:px-0">
          <div className="grid grid-cols-[1fr_auto] items-center md:grid-cols-3">
            ...
            <div
              id="navbarNav"
              className="hidden justify-center md:flex md:justify-self-center"
            >
              <ul className="m-0 flex list-none items-center p-0">
                {navItems.map((item) => (
                  <li key={item.href} className="mx-[15px]">
                    <Link
                      className={`${desktopLinkClass(item.href)} block px-0 py-[8px]`}
                      href={item.href}
                    >
                      {item.label}
                    </Link>
            ...
            <div
              className="hidden h-10 w-10 md:block md:justify-self-end"
              aria-hidden="true"
            />
          </div>
